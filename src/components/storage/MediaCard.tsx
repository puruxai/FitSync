...
// Displays file preview card with permissions dropdowns, sizing stats, and delete actions
...
export const MediaCard: React.FC<MediaCardProps> = ({
  ...
  return (
    <Card variant="glass" className="p-3 border border-slate-200/50 dark:border-slate-800/40 rounded-3xl flex flex-col justify-between text-left select-none group min-h-60 overflow-hidden relative">
      
      {/* File preview */}
      <div className="w-full h-32 bg-slate-100 dark:bg-slate-900 rounded-2xl overflow-hidden mb-3 relative flex items-center justify-center">
        {isImage && (
          <img
      ...
      <div className="space-y-1 px-1">
        <h4 className="text-[11px] font-black text-slate-850 dark:text-white truncate" title={file.filename}>
          {file.filename}
        </h4>
